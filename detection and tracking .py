...
path = '/content/drive/MyDrive/Colab Notebooks/KALMAN FILTER PROJECT/Klaman filter images'
...
cwd = os.path.dirname(os.path.realpath('/content/drive/MyDrive/Colab Notebooks/KALMAN FILTER PROJECT/Klaman filter images'))
...
cwd = os.path.dirname(
    os.path.realpath('/content/drive/MyDrive/Colab Notebooks/KALMAN FILTER PROJECT/Klaman filter images'))
...
class CarDetector(object):
    def __init__(self):
        ...
        detect_model_name = '/content/drive/MyDrive/Colab Notebooks/KALMAN FILTER PROJECT/ssd_mobilenet_v1_coco_11_06_2017'
